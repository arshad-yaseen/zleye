			...
			z.object({
				entry: z
					.union(
						...
						z
							.array(z.string())
							.describe('Multiple entrypoints for declaration file generation'),
					)
					.optional(),
				resolve: z
					.union(
